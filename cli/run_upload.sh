...
# Tantor Inc AI Support Bot - Document Upload Tool for Unix/Linux/macOS
# This script launches the document upload interface
...
if [ $? -ne 0 ]; then
    echo
    echo "Upload tool exited with an error."
